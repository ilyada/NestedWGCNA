...
def genfocus(df, focus_gene='PTPRC', method='spearman', tpm=True, corr_thr=0.9, CVR_thr=0.6):
    ...
    # finding genes correlated with focus gene
    if focus_gene=='eigengene':
        ...
        cor = df_tpm.corrwith(eigengene, axis=0, method=method)
    else:
